export default function Comment() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="w-full max-w-5xl bg-gray-100 p-8 rounded-md shadow-md">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <textarea
              className="w-full bg-white border border-gray-300 rounded-md p-3 focus:ring-2 focus:ring-green-600 focus:outline-none"
